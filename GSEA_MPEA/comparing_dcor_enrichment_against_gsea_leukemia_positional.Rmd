---
title: "Comparing MPEA against GSEA Leukemia dataset"
...
```{r}
gsea_results <- read.csv("./GSEA leukemia/gsea_leukimia_enrichment_results6.2_positional.csv", sep = ",", row.names = 1)
...
stopCluster(cl)
save.image(file = "leukemia_positional.Rdata")
