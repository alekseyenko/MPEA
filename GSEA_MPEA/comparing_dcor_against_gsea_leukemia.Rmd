---
title: "Comparing Dcor against GSEA Leukemia dataset"
...
```{r}
gsea_results <- read.csv("./GSEA leukemia/gsea_leukimia_enrichment_results6.2.csv", sep = ",", row.names = 1)
...
enrichment_ratio_dcor <- NULL
enrichment_ratio_ttest <- NULL
if ( !(identical(Significant_in_GSEA_not_in_dcor,character(0)))){
