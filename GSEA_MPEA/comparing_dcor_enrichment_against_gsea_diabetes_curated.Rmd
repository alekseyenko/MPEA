---
title: "Comparing MPEA against GSEA Diabetes dataset"
...
```{r}
gsea_results <- read.csv("./GSEA diabetes/gsea_diabetes_enrichment_results_v6.2_curated.csv", sep = ",", row.names = 1)
...
stopCluster(cl)
save.image(file = "diabetes_curated.Rdata")
```
