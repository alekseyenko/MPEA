---
title: "Comparing Dcor against MPEA Lung cancer Michigan study"
...
```{r}
gsea_results <- read.csv("./lung cancer/gsea_lung_michigan_enrichment_results_v6.2_curated.csv", sep = ",", row.names = 1)
...
stopCluster(cl)
save.image(file = "lung_mich_curated.Rdata")
```
