---
title: "Comparing MPEA against GSEA P53 dataset"
...
```{r}
gsea_results <- read.csv("./gsea p53/gsea_p53_enrichment_results6.2_positional.csv", sep = ",", row.names = 1)
...
stopCluster(cl)
save.image(file = "p53_positional.Rdata")
